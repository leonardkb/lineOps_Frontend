...
function CapacityHistoryModal({ operationId, operationName, operatorNo, onClose }) {
  ...
  const fetchHistory = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/operation-capacity-history/${operationId}`, {
        headers: {
...
export default function ViewEditOperationPlanner({
  ...
  const saveOperationChanges = async (row) => {
    ...
    try {
      ...
      const response = await fetch(`/api/update-operation/${runId}`, {
        method: "PUT",
        headers: {
                              ...
                              <div key={field}>
                                ...
                                {isEditing ? (
                                  <input
                                    ...
                                    className="w-full rounded-lg border border-gray-200 px-2 py-1 focus:ring-2 
