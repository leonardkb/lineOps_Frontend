          ...
          <ul className="hidden md:flex gap-3 font-medium">
            <li>
              <button
                ...
                className="cursor-pointer transition px-3 py-1.5 rounded-lg 
                text-sm hover:bg-white/10 flex items-center gap-1.5"
              >
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 bg-white/5 rounded-lg p-2">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              disabled={loading}
              className="bg-blue-600 hover:bg-blue-700 text-white px-2.5 py-1 
              rounded-lg text-xs font-medium disabled:opacity-50 flex items-center
               gap-1 shadow-sm border border-blue-400"
            >
