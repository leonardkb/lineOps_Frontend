        ...
        <div className="hidden md:flex items-center gap-6 font-medium">
          ...
          <div className="relative">
            <button
              ...
              text-white rounded-lg hover:bg-gray-700 transition-colors flex items-center gap-2"
            >
              <span>Alertas</span>
            ...
            {showAlerts && (
              <div className="absolute right-0 mt-2 w-96 bg-white
        ...
        <div className="bg-gray-800 md:hidden">
          <div className="flex flex-col gap-4 px-6 py-4 font-medium">
            ...
            <button
              ...
              className="w-full text-left px-4 py-3 bg-gray-700 text-white rounded-lg 
              hover:bg-gray-600 transition-colors flex justify-between items-center"
            >
              <span>Alertas</span>
