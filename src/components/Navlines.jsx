...
export default function Navlines({ 
  ...
  const fetchAllLines = async () => {
    ...
    try {
      const response = await axios.get(`/api/lines`, { headers });
            ...
            <div className="relative">
              <button
                ...
                className="relative px-4 py-2 text-sm font-medium
                 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-colors flex items-center gap-2"
              >
                <span>Alertas</span>
                {alertCount > 0 && (
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white
             px-6 py-2.5 rounded-lg text-base font-medium disabled:opacity-50 flex items-center gap-2 shadow-sm transition-colors"
          >
        ...
        <div className="bg-gray-800 md:hidden">
          <div className="flex flex-col gap-4 px-6 py-4">
            ...
            <button
              ...
              rounded-lg hover:bg-gray-600 transition-colors flex justify-between items-center"
            >
              <span>Alertas</span>
              {alertCount > 0 && (
